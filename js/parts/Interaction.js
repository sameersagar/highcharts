...
import './Legend.js';
import './Series.js';
var Chart = H.Chart, createElement = H.createElement, css = H.css, defaultOptions = H.defaultOptions, defaultPlotOptions = H.defaultPlotOptions, hasTouch = H.hasTouch, Legend = H.Legend, merge = H.merge, Series = H.Series, seriesTypes = H.seriesTypes, svg = H.svg, TrackerMixin;
