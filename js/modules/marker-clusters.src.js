...
var Series = H.Series, Scatter = H.seriesTypes.scatter, SvgRenderer = H.SVGRenderer, merge = H.merge, isFunction = H.isFunction, error = H.error, baseGeneratePoints = Series.prototype.generatePoints, stateIdCounter = 0, 
